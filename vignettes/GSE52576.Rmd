...
print(p_mirror)
message("✓ Bmirror_density plot complete")

### Plot 3: Circular heatmap (complex multi-dimensional view)
...
The **heatmap** shows normalized methylation levels (beta values) across all probes and samples, organized by Sample_Group.
