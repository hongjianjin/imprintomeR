...
saveRDS(qcset_pass, file = file.path(qc_outdir, "GSE240091_qcset_pass.rds"))
...
if (!is.null(plots(x)[["circular.selected"]])) {
...
x <- runImprintomeVisualizations(
  ...
  prefix = "GSE240091_beeswarm_origin",
  store_plots = TRUE,
  save_plots = FALSE,
  verbose = TRUE
)
...
x <- runImprintomeVisualizations(
  ...
  probeset = "selected",
  prefix = "GSE240091_mirror_density",
  store_plots = TRUE,
  save_plots = FALSE,
  verbose = TRUE
)
...
x <- runImprintomeVisualizations(
  ...
  prefix = "GSE240091_circular_heatmap",
  store_plots = TRUE,
  save_plots = FALSE,
  verbose = TRUE
)
...
x <- runImprintomeVisualizations(
  ...
  prefix = "GSE240091_heatmap_by_probe",
  store_plots = TRUE,
  save_plots = FALSE,
  verbose = TRUE
)
...
x <- runImprintomeVisualizations(
  ...
  clusterRows = TRUE,
  clusterColumns = TRUE,
  prefix = "GSE240091_heatmap_by_gene",
  store_plots = TRUE,
  save_plots = FALSE,
  verbose = TRUE
)
