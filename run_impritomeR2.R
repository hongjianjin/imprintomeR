...
if( 4 %in% steps){
        cat("\nstep4. 3x3 nine square plot\n")
        pdfFile <-  paste0(prefix,"_",probeset,"_IDS_9square_plot.pdf")
        tmp <- VizNineSquares(idsFile, idsFile, 
        ShapeColumn="Mechanism", IdColumn='SAMPLE_NAME', groupColumn='SAMPLE_GROUP', ColorColumn="SAMPLE_GROUP",
        ...
        outFile=pdfFile, label=F, title="chr11p15 classifier",palette="Default",alpha=0.6,dotSize=NULL, ggside="density", splitside="overall")
}   
if( 5 %in% steps){
